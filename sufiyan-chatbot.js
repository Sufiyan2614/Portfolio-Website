...
(function () {
  ...
  style.textContent = `
    ...
    #sm-chat-window { position:fixed; bottom:100px; right:32px; width:380px; height:560px; background:var(--bg,#f8f7ff); border:1px solid var(--border,#ddd8f8); border-radius:20px; display:flex; flex-direction:column; z-index:998; box-shadow:0 20px 60px rgba(87,0,239,0.15),0 4px 20px rgba(0,0,0,0.08); overflow:hidden; transform:translateY(20px) scale(0.95); opacity:0; pointer-events:none; transition:transform 0.4s cubic-bezier(0.16,1,0.3,1),opacity 0.35s ease; transform-origin:bottom left; }
